...
const BossfootyConfig = {
  ...
  dllPlugin: {
    ...
    entry(pkg) {
      ...
      const exclude =
        pkg.dllPlugin.exclude || BossfootyConfig.dllPlugin.defaults.exclude;
      const include =
        pkg.dllPlugin.include || BossfootyConfig.dllPlugin.defaults.include;
...
module.exports = BossfootyConfig;
